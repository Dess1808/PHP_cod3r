<nav class="modulos">
    ...
    <div class="modulo roxo">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=estruturas_controle&file=op_logicos">
                    Operadores Lógicos
                </a>
            </li>
            ...
            <li>
                <a href="exercicio.php?dir=estruturas_controle&file=desafio_op_logicos">
                    Desafio Operadores Lógicos
                </a>
            </li>

            <li>
                <a href="exercicio.php?dir=estruturas_controle&file=op_ternario">
                    Operador Ternário 
                </a>
            </li>
    ...
    <div class="modulo verde-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=repeticoes&file=doWhileWhile">
                        Do While/ While
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=repeticoes&file=desafioTabela">
                        desafioTabela
                </a>
            </li>
            <li>
    ...
    <div class="modulo roxo-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=include&file=includeFuncoes">
                    Include em Funções
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=include/desafioRequire&file=instancia">
                    Desafio Require 
                </a>
            </li>
             <li>
    ...
    <div class="modulo roxo">
        ...
        <ul>
            <li>
                <a href="exercicio.php?dir=form&file=form">
                    Form
                </a>
            </li>
        </ul>
